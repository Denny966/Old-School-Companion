...
public class OSRSNewsParser {
    ...
    public ArrayList<OSRSNews> parse(final String xml)
    ...
    private ArrayList<OSRSNews> readFeed(XmlPullParser parser)
            throws XmlPullParserException, IOException, ParseException {
        ArrayList<OSRSNews> news = new ArrayList<>();
