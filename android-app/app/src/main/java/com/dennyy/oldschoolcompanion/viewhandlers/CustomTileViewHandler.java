...
public class CustomTileViewHandler extends BaseViewHandler implements AdvancedWebView.Listener, View.OnClickListener, ObservableScrollViewCallbacks {

    public static final String TILE_DATA_PARAMETER = "tile_data_parameter";
    ...
    public CustomTileViewHandler(final Context context, View view, String name, String url, boolean isFloatingView) {
        ...
        if (isFloatingView) {
            ...
            navBarTitle.setOnClickListener(this);
    ...
    public void onPageFinished(String url) {
        navBarTitle.setText(Utils.isNullOrEmpty(webView.getTitle()) ? name : webView.getTitle());
    ...
    public void setWebViewVisibiliy(int visibiliy) {
        webView.setVisibility(visibiliy);
    }
