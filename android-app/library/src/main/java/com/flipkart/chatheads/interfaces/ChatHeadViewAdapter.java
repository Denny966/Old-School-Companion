...
public interface ChatHeadViewAdapter {
     ...
     */
    View attachView(String key, ChatHead chatHead, ViewGroup parent);
     ...
     */
    void detachView(String key, ChatHead chatHead, ViewGroup parent);
     ...
     */
    void removeView(String key, ChatHead chatHead, ViewGroup parent);
     ...
     */
    Drawable getChatHeadDrawable(String key);
}
